...
const getWatchlist = async (movie) => {
    console.log(`https://www.omdbapi.com/?apikey=${api}&t=${movie}`)
    const response = await fetch(`https://www.omdbapi.com/?apikey=${api}&i=${movie}`);
